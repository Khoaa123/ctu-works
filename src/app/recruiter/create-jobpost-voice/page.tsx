...
const CreateJobPostAIVoice = () => {
  ...
  const handleNextField = () => {
    ...
    if (nextIndex < keys.length) {
      ...
      TextToSpeech(
        `'Đã điền xong tất cả các trường vui lòng bấm vào nút tiếp tục để AI tiến hành xử lý.`
      );
    }
  };
      ...
      <div className="flex flex-col items-center py-10">
        {showChoseFile && (
          <div className="flex flex-col items-center">
            ...
            <div className="flex">
              <button
                style={isFormStarted ? disabledButtonStyle : customButtonStyle}
                className="m-2"
                disabled={isFormStarted}
                onClick={startEnterForm}
              >
                Bắt đầu
              </button>
              <button
                style={isFormStarted ? customButtonStyle : disabledButtonStyle}
                className="m-2"
                disabled={!isFormStarted}
